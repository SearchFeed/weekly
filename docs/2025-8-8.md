...
## 前端技术
- [V8 引擎如何让JSON.stringify提升两倍](https://v8.dev/blog/json-stringify)
...
- [Node.js 升级到 v24.5.0](https://nodejs.org/en/blog/release/v24.5.0)
...
- [TypeScript 5.9 发布](https://devblogs.microsoft.com/typescript/announcing-typescript-5-9/)
